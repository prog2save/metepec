                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <td class="px-4 sm:px-6 py-3.5">
                            <form action="{{ route('usuarios.destroy', $user->id) }}" method="POST"
                                class="inline-block"
                                onsubmit="return confirm('¿Suspender a {{ $user->nombre }}?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="inline-flex items-center justify-center text-gray-400 hover:text-red-700 transition-colors duration-200">
