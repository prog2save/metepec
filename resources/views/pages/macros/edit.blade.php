...
@section('content')
<x-common.page-breadcrumb pageTitle="Editar macro" />

<form action="{{ route('macros.update', $macro) }}" method="POST">
@csrf
@method('PUT')
...
<div class="flex gap-4 items-start">
    ...
    <div class="w-72 shrink-0 space-y-3">
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-700 dark:bg-gray-900">
            ...
            <div class="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-gray-800">
                <h2 class="text-sm font-semibold text-gray-800 dark:text-white/90">Editar macro</h2>
            ...
            <div class="space-y-4 p-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $macro->name) }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800
                               ...
                               text-gray-800 focus:ring-3 focus:outline-hidden
                               dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 resize-none">{{ old('description', $macro->description) }}</textarea>
                </div>
    ...
    <div class="flex-1 min-w-0">
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-700 dark:bg-gray-900">
            ...
            <div
                x-data="{
                    actions: @js(old('actions', $macro->actions->map(fn($a) => ['field' => $a->field, 'value' => $a->value])->toArray())),
                    fields: @js($fields),
