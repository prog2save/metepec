...
<div class="space-y-6">
    ...
    <x-common.component-card title="Crear Estado del Ticket">

        <form action="{{ route('estados.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <select name="categoria" id="categoria"
                    ...
                    <option value="Abierto"   {{ old('categoria') == 'Abierto'   ? 'selected' : '' }}>Abierto</option>
                    <option value="Pendiente" {{ old('categoria') == 'Pendiente' ? 'selected' : '' }}>Pendiente</option>
                    <option value="Resuelto"  {{ old('categoria') == 'Resuelto'  ? 'selected' : '' }}>Resuelto</option>
                </select>
                @error('categoria')
            ...
            <div>
                ...
                <input type="text" id="nombre_agente" name="nombre_agente"
                    value="{{ old('nombre_agente') }}" maxlength="50"
            ...
            <div>
                ...
                <input type="text" id="descripcion_agente" name="descripcion_agente"
                    value="{{ old('descripcion_agente') }}" maxlength="200"
            ...
            <div id="userViewSection"
                class="{{ old('vista_usuario') ? '' : 'hidden' }} ml-7 space-y-5 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                ...
                <div>
                    ...
                    <input type="text" id="nombre_usuario" name="nombre_usuario"
                        value="{{ old('nombre_usuario') }}" maxlength="50"
                ...
                <div>
                    ...
                    <input type="text" id="descripcion_usuario" name="descripcion_usuario"
                        value="{{ old('descripcion_usuario') }}" maxlength="200"
            ...
            <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <x-ui.button size="sm" variant="primary" type="submit">Guardar</x-ui.button>
            </div>
