    ...
    <x-common.component-card title="Editar Usuario">
        ...
        <form action="{{ route('usuarios.update', $usuario->id) }}" method="post">
            ...
            <div>
                ...
                <input type="number" maxlength="10" id="telefono" name="telefono" value="{{ old('telefono', $usuario->telefono) }}"
                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
            ...
            <div>
                ...
                <input type="text" maxlength="18" id="curp" name="curp" value="{{ old('curp', $usuario->curp) }}"
                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
            ...
            <div>
                <x-ui.button size="sm" variant="primary" type="submit" class="mt-4">Actualizar Usuario</x-ui.button>
            </div>
        </form>
