...
class MenuHelper
{
    ...
    public static function getMainNavItems()
    {
        return [
            ...
            [
                ...
                'subItems' => [
                    ['name' => 'Lista', 'path' => '/ciudadanos/'],
                    ['name' => 'Alta', 'path' => '/ciudadanos/create'],
                ],
            ],
            [
                'icon' => 'address-icon',
                'name' => 'Direcciones Municipales',
                'path' => '/direcciones-municipales',
                'subItems' => [
                    ['name' => 'Lista', 'path' => '/direcciones/'],
                    ['name' => 'Alta', 'path' => '/direcciones/create'],
                ],
            ],
            [
                'icon' => 'service-icon',
            ...
            [
                ...
                'path' => '/estados',
                'subItems' => [
                    ['name' => 'Estados de Tickets', 'path' => '/estados/'],
    ...
    public static function getMainNavItemsOld()
    {
        return [
            [
                'icon' => 'dashboard',
